...
function! s:MRU_Print_Line_And_Exit()
    let fname = getline('.', '.')
...
function! s:MRU_Open_Window()
    ...
    nnoremap <buffer> <silent> <TAB> :call <SID>MRU_Window_Edit_File(1)<CR>
    nnoremap <buffer> <silent> u :MRU<CR>
    nnoremap <buffer> <silent> <2-LeftMouse>
                \ :call <SID>MRU_Window_Edit_File(0)<CR>
    nnoremap <buffer> <silent> q :close<CR>
    nnoremap <buffer> <silent> <C-D> :call <SID>MRU_Print_Line_And_Exit()<CR>
    nnoremap <buffer> <silent> <C-K> :call <SID>MRU_Print_Line_And_Exit()<CR>
